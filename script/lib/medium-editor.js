...
(function(window, document) {
    ...
    MediumEditor.prototype = {
        ...
        serialize: function() {
            //clear image/video "remove" button
            $('div.medium-remove-content').each(function() {
        ...
        buttonTemplate: function(btnType) {
            var buttonLabels = this.getButtonLabels(this.options.buttonLabels),
                buttonTemplates = {
                    ...
                    'youtube': '<li><button class="medium-editor-action medium-editor-action-youtube" data-action="youtube" data-element="img">' + buttonLabels.youtube + '</button></li>',
        ...
        getButtonLabels: function(buttonLabelType) {
            ...
            if (buttonLabelType === 'fontawesome') {
                customButtonLabels = {
                    ...
                    'youtube': '<i class="fa fa-video-o"></i>',
        ...
        execAction: function(action, e) {
            if (action.indexOf('append-') > -1) {
                ...
                this.insertImage(this.selection);
            } else if (action === 'youtube') {
                this.insertYoutube(this.selection);
            } else {
        ...
        insertYoutube: function(el) {
            var e = el.anchorNode.parentNode;
            var val = $(e).html();
            var p = /^(?:https?:\/\/)?(?:www\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))((\w|-){11})(?:\S+)?$/;
            val = (val.match(p)) ? RegExp.$1 : 'TuTx4aFCaas';

            $(e).replaceWith('<div class="medium-remove-content" onclick="$(this).remove();" >remove<iframe class="medium-video" src="//www.youtube.com/embed/' + val + '" allowfullscreen></iframe></div>');
            this.hideAnchorPreview();
            return this;
        },
        ...
        insertImage: function(el) {
            var e = el.anchorNode.parentNode;
            var val = $(e).html();
            $(e).replaceWith('<div class="medium-remove-content" onclick="$(this).remove();" >remove<img class="medium-image" src="' + val + '"></div>');
            this.hideAnchorPreview();
            return this;
        },
